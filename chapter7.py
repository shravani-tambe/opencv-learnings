...
#HSV min and max range changed according to the trackbars to find a mask 
...
while True:
    ...
    #CURRENT HSV MIN AND MAX COLOURS TRACKED
    ...
    there's a one and the image segment is present 
    
    bitwise with the mask and the original HSV, obtains detected colour '''
